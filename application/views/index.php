<section class="info-section">
	<div class="container">
		...
		<div class="row itens" id="rowItens">
			...
			<div class="col-xs-12 col-sm-4 container-item">
				<div class="item">
					...
					<p class="item-date">
						...
						echo strftime('%#d de %B de %Y', strtotime($noticias_item['data']));
						?>
					</p>
					<h2 class="item-title">
						<?php 
			...
			<div class="row">
				<div class="col-md-6 col-lg-6 content-half mt-md-0 pt-4">
					<div class="head-box mb-5 pl-5 mt-2">
						...
						<a href="#">
							<h6 class="text-white text-underline-rb-white">Veja todos os nossos informes <i class="fa fa-plus-circle" aria-hidden="true"></i></h6>
						</a>
					</div>
					<ul class="pl-5">
						<li>
				...
				<div class="col-lg-6 mbr-col-md-10">
					<div class="wrap">
						...
						<div class="text-wrap vcenter">
							...
							<p class="mbr-fonts-style text1 mbr-text display-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi et auctor nisl. Integer a vulputate sapien, a mattis urna. Praesent eget velit lorem. Curabitur at magna ante. </p>
						</div>
					</div>
				</div>
				<div class="col-lg-6 mbr-col-md-10">
