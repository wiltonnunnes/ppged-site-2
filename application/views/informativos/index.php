                ...
                <div class="container-fluid gedf-wrapper">
                    ...
                    ?>
                        ...
                        <div class="col-md-4 gedf-main">
                            <p class="text-muted h7 mb-2"><i class="far fa-calendar"></i> <?php setlocale(LC_ALL, NULL); echo strftime('%#d de %B de %Y', strtotime($informativos_item['data'])); ?></p>
                            <a class="card-link" href="<?php echo site_url('informativos/' . $informativos_item['informativo_id']); ?>">
                                <h2 class="card-title"><?php echo $informativos_item['titulo']; ?></h2>
                            </a>
                        </div>
