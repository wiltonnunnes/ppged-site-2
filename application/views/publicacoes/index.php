          ...
          <div class="col-md-8 mb-sm-8">
            <div class="container-fluid gedf-wrapper" id="container-publicacoes">
              ...
              <div class="col-md-4 gedf-main container-item">
                ...
                <div class="thumbnail">
                  <a href="#" data-toggle="modal" data-target="#publicacaoDetails"
                    data-id="<?php echo $publicacoes_item['publicacao_id']; ?>" class="modal-button">
...
<div class="modal" id="publicacaoDetails" tabindex="-1" role="dialog" aria-labelledby="professorDetailsLabel"
